Locales['fr'] = {
  ...
  ['spawnpoint_blocked'] = 'Il y a un vehicule à la sortie !',
  ['only_hotel'] = 'vous ne pouvez ranger que les voitures de l\'hôtel',

  ['taking_service'] = 'prise de service : hotel',
  ...
  ['hotel'] = 'vous devez être dans un hotel pour commencer la mission',
